...
template <typename T>
__global__ void vector_add_scalar_kernel(T *c, const T *a, const T *b, size_t numel) {
...
template <typename T>
__global__ void vector_add_packed_kernel(T *c, const T *a, const T *b, size_t numel) {
...
template <typename T>
void launch_vector_add(T *c, const T *a, const T *b, size_t numel) {
...
void add(std::byte *c, const std::byte *a, const std::byte *b, zedinferDataType_t type, size_t numel) {
    ...
    case ZEDINFER_DTYPE_F32:
        return launch_vector_add(reinterpret_cast<float *>(c),
                                 reinterpret_cast<const float *>(a),
                                 reinterpret_cast<const float *>(b), numel);
    case ZEDINFER_DTYPE_F16:
        return launch_vector_add(reinterpret_cast<half *>(c),
                                 reinterpret_cast<const half *>(a),
                                 reinterpret_cast<const half *>(b), numel);
    case ZEDINFER_DTYPE_BF16:
        return launch_vector_add(reinterpret_cast<cuda_bfloat16 *>(c),
