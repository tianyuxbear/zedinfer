...
struct MemoryPoolConfig {
    ...
    std::vector<size_t> preallocate_sizes = {1 * 1024 * 1024, 16 * 1024 * 1024, 64 * 1024 * 1024, 256 * 1024 * 1024};
};
...
public:
    ...
    BestFitMemoryPool(AllocFunc alloc_func, FreeFunc free_func, const MemoryPoolConfig& config = MemoryPoolConfig());
